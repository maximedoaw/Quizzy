...
function Card({ username, category, quizzName, timestamp, imageURL }) {
  return (
<div className="flex flex-col border shadow-md hover:shadow-xl rounded-lg overflow-hidden transition-shadow duration-300 m-5 w-[350px] bg-white cursor-pointer">
  {/* Image Section */}
